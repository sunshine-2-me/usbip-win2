...
Name: usbipbroker_automount; Description: "Disable &global volume automount (mountvol /N) for per-session drive letters"; GroupDescription: "USBip Broker (RDS per-user isolation)"; Flags: unchecked
